...
export function InputBar({
  ...
  if (voiceRecorder.status === "permission-denied") {
    return (
      <div className="flex items-center justify-between gap-3 border-t border-parchment-2 bg-white px-3 py-2 text-sm text-ink">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-2 border-t border-parchment-2 bg-white px-3 py-2">
      <button
        type="button"
